...
void MJSTaku::KyokuInit(MJSTkinfo *tk, MJSPlayer *ply){
	...
	for( int tmp_pnum = 0; tmp_pnum < 4 ; tmp_pnum++ ) {
		...
		// プレーヤーアクション - 局開始
		ply[tmp_pnum].PlyActKyokuStart(tk->kyoku[tk->kyoku_index].ie[tmp_pnum]);
...
*/
                         ...
                         24,24,25,26,26,17,17,18,18,19,19, 9, 9,                // 配牌：プレーヤー(チューレン)
...
void MJSTaku::SetHowanpai(MJSTkinfo *tk, MJSPlayer *ply){
	...
	for(int tmp_num = 0; tmp_num < PLAYER_MAX; tmp_num++){
		...
		if( tk->shanten_total[tmp_num] == 0 ){
			tk->kyoku[tk->kyoku_index].yk.ply_tempai_flg[tmp_num] = true;
			tk->kyoku[tk->kyoku_index].yk.ply_tempai_count++;
		}else{
			tk->kyoku[tk->kyoku_index].yk.ply_tempai_flg[tmp_num] = false;
		}
	...
	// -----------------------------------------------------------
	for(int tmp_num = 0; tmp_num< PLAYER_MAX; tmp_num++){
		if(tk->kyoku[tk->kyoku_index].yk.ply_tempai_count == 0 || tk->kyoku[tk->kyoku_index].yk.ply_tempai_count == 4){
			tk->kyoku[tk->kyoku_index].yk.kyoku_score[tmp_num] = 0;
		}else if(tk->kyoku[tk->kyoku_index].yk.ply_tempai_count == 1 && tk->kyoku[tk->kyoku_index].yk.ply_tempai_flg[tmp_num] == true){
			tk->kyoku[tk->kyoku_index].yk.kyoku_score[tmp_num] = 3000;
		}else if(tk->kyoku[tk->kyoku_index].yk.ply_tempai_count == 1 && tk->kyoku[tk->kyoku_index].yk.ply_tempai_flg[tmp_num] == false){
			tk->kyoku[tk->kyoku_index].yk.kyoku_score[tmp_num] = -1000;
		}else if(tk->kyoku[tk->kyoku_index].yk.ply_tempai_count == 2 && tk->kyoku[tk->kyoku_index].yk.ply_tempai_flg[tmp_num] == true){
			tk->kyoku[tk->kyoku_index].yk.kyoku_score[tmp_num] = 1500;
		}else if(tk->kyoku[tk->kyoku_index].yk.ply_tempai_count == 2 && tk->kyoku[tk->kyoku_index].yk.ply_tempai_flg[tmp_num] == false){
			tk->kyoku[tk->kyoku_index].yk.kyoku_score[tmp_num] = -1500;
		}else if(tk->kyoku[tk->kyoku_index].yk.ply_tempai_count == 3 && tk->kyoku[tk->kyoku_index].yk.ply_tempai_flg[tmp_num] == true){
			tk->kyoku[tk->kyoku_index].yk.kyoku_score[tmp_num] = 1000;
		}else if(tk->kyoku[tk->kyoku_index].yk.ply_tempai_count == 3 && tk->kyoku[tk->kyoku_index].yk.ply_tempai_flg[tmp_num] == false){
			tk->kyoku[tk->kyoku_index].yk.kyoku_score[tmp_num] = -3000;
		}
	}
	...
	for(int tmp_i = 0; tmp_i < PLAYER_MAX; tmp_i++){
		tk->kyoku[tk->kyoku_index].ply_kyoku_end_score[tmp_i] = tk->kyoku[tk->kyoku_index].ply_kyoku_start_score[tmp_i] 
		                                                      + tk->kyoku[tk->kyoku_index].yk.kyoku_score[tmp_i];
	}
...
void MJSTaku::KyokuNextInit(MJSTkinfo *tk, MJSPlayer *ply){
	...
	// 東風モード
	// -----------------------------------------------------------
	}else if( tk->tk_test_mode == PLAYGAME_TONPU ){

		// 次局に移るか？
		if ( tk->kyoku[tk->kyoku_index].kyoku < 3 ){

			// 親和了
			if( tk->kyoku[tk->kyoku_index].yk.ryukyoku_flg  == false &&
			    tk->kyoku[tk->kyoku_index].yk.agari_ply_num == tk->kyoku[tk->kyoku_index].kyoku_oya){
