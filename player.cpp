 ...
 * バージョン     ： 0.1.2.0.174(mjsply2020からのバックポート)
 * プログラム名   ： mjs.exe
 * ファイル名     ： player.cpp
 * クラス名       ： MJSPlayerクラス
 * 処理概要       ： プレーヤークラス
...
// 卓開始処理
/* ---------------------------------------------------------------------------------------------- */
void MJSPlayer::PlyActTakuStart(int tmp_ply_num){
...
// 局開始処理
/* ---------------------------------------------------------------------------------------------- */
void MJSPlayer::PlyActKyokuStart(int tmp_ie){
...
// メンツ削除処理
/* ---------------------------------------------------------------------------------------------- */
void MJSPlayer::mentu_cut(int hai){
...
// ターツ削除処理
/* ---------------------------------------------------------------------------------------------- */
void MJSPlayer::taatu_cut(int hai){
...
// メンツ削除処理(面子情報付与版)
/* ---------------------------------------------------------------------------------------------- */
void MJSPlayer::mentu_cut_detail(int hai){
...
// ターツ削除処理(ターツ情報付与版)
/* ---------------------------------------------------------------------------------------------- */
void MJSPlayer::taatu_cut_detail(int hai){
